...
/*
he copy constructor is a constructor which creates an object by initializing it with an 
...
the compiler itself defines one.If the class has pointer variables and has some dynamic memory allocations, 
